...
and the intake pipeline now WORKS end to end - the remote relay is built,
adversarially reviewed, and ACCEPTED (steps 1-11, D-089, 2026-08-11) - though
a REAL-BROWSER smoke of the built form is a new residual verification owed
before deploy (D-089). Still owed: keygen ceremony executed + D-023 sign-off
+ that real-browser smoke. Every other gate stands unchanged. HANDOFF.md is
the live gate authority.
